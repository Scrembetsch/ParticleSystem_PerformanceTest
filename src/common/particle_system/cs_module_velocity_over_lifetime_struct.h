...
class CsModuleVelOverLifeStruct : public CsIModuleStruct
{
public:
	CsModuleVelOverLifeStruct(CsParticleSystemStruct* particleSystem);
	CsModuleVelOverLifeStruct(CsParticleSystemStruct* particleSystem, const glm::vec3& velBegin, const glm::vec3& velEnd);
